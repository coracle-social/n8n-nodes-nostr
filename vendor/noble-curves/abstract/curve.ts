// Vendored from @noble/curves@1.9.7 (abstract/curve.ts) -- MIT License.
...
import { bitLen, bitMask, validateObject } from '../utils';
import { Field, FpInvertBatch, nLength, validateField, type IField } from './modular';
