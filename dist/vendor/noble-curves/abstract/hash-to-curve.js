...
function normDST(DST) {
    if (!(0, utils_1.isBytes)(DST) && typeof DST !== 'string')
        throw new Error('DST must be Uint8Array or string');
    return typeof DST === 'string' ? (0, utils_1.utf8ToBytes)(DST) : DST;
}
...
function hash_to_field(msg, count, options) {
    (0, utils_1._validateObject)(options, {
        p: 'bigint',
        m: 'number',
        k: 'number',
        hash: 'function',
    ...
    if (!(0, utils_1.isHash)(options.hash))
...
function isogenyMap(field, map) {
    ...
    return (x, y) => {
        ...
        const [xd_inv, yd_inv] = (0, modular_1.FpInvertBatch)(field, [xd, yd], true);
        x = field.mul(xn, xd_inv);
        y = field.mul(y, field.mul(yn, yd_inv));
        return { x, y };
    };
}
exports._DST_scalar = (0, utils_1.utf8ToBytes)('HashToScalar-');
